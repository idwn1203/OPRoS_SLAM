...
int32_t StellaB1WheelController::Initialize(OPRoS::Property parameter)	
{
	...
	if (SetStellaB1Profile(parameter) == false)
	{
		PrintMessage("Can not set profile");
		return API_ERROR;
	}	

	if (((SerialCommunication *)m_uart)->InitializeSerial(parameter) != API_SUCCESS)
	{
		PrintMessage("[Initialize] Can not initialize uart");
		return API_ERROR;
	}
...
int32_t StellaB1WheelController::Finalize()
{
...
int32_t StellaB1WheelController::Enable()
{
	if (status == DEVICE_ACTIVE)
	{
		PrintMessage("Already enabled");
		return API_SUCCESS;
	}
	...
	{
		PrintMessage("Can not enable uart");
		return API_ERROR;
	}
	...
	if ((errorCode = m_stellaB1.ControlInit()) != StellaB1::NONE_ERROR)
	{
		PrintMessage(StellaB1::ConvertToString(errorCode).c_str());
		return API_ERROR;
	}
...
int32_t StellaB1WheelController::Disable()
{
	m_rwLockStatus.WriterLock();
	if (status == DEVICE_READY)
	{
		PrintMessage("Already disabled");
		m_rwLockStatus.WriterUnlock();
		return API_SUCCESS;
	}
	...
	{
		PrintMessage("Can not disable uart");
		m_rwLockStatus.WriterUnlock();
		return API_ERROR;
	}
...
int32_t StellaB1WheelController::SetProperty(OPRoS::Property parameter )
{
	...
	{
		PrintMessage("Can not set uart parameter");
		return API_ERROR;
	}
...
int32_t StellaB1WheelController::GetProperty(OPRoS::Property &parameter )
{
	...
	{
		PrintMessage("Can not get UART parameter");
		return API_ERROR;
	}
...
int32_t StellaB1WheelController::SetPosition(OPRoS::MobilePositionData position )
{
	std::cout << "\nstellaB1::setposition1\n" << std::endl;
	...
	std::cout << "\nstellaB1::setposition2\n" << std::endl;

	//////////////////////////////////////////////////////////////////////////
	m_mutexWheelPosition.Lock();
	std::cout << "B1.m_wheelPosition : " << m_wheelPosition.x << "\n" << m_wheelPosition.y << "\n" << m_wheelPosition.theta <<
		"\n" << "int32_t StellaB1WheelController::SetPosition(OPRoS::MobilePositionData position )" << std::endl;
	...
	std::cout << "\nstellaB1::setposition3\n" << std::endl;

	m_rwLockStatus.ReaderUnlock();
	return API_SUCCESS;
}

int32_t StellaB1WheelController::GetPosition(OPRoS::MobilePositionData& position )
{
	std::cout << "\nstellaB1::getposition1\n" << std::endl;
	...
	std::cout << "\nstellaB1::getposition2\n" << std::endl;

	//////////////////////////////////////////////////////////////////////////
	m_mutexWheelPosition.Lock();
	std::cout << "B1.Position : " << m_wheelPosition.x << "\n" << m_wheelPosition.y << "\n" << m_wheelPosition.theta << "\n" << std::endl;
...
// 2015.07.14 mskim
int32_t StellaB1WheelController::MoveBase( float64_t distance, float64_t linearVelocity )
...
//int StellaB2WheelController::MoveWheel( double distance, double linearVelocity )
{
	...
	if(time == 0)
	{
		PrintMessage("Velocity is so fast");
		m_rwLockStatus.ReaderUnlock();
		return API_ERROR;
	}
...
// 2015.07.14 mskim
int32_t StellaB1WheelController::IsBaseRunning( bool& isWheelRunning )
{	
	std::cout<<"IsBaseRunning: status="<<status<<std::endl;
...
// 2015.07.14 mskim
int32_t StellaB1WheelController::DriveBase( float64_t linearVelocity, float64_t angularVelocity )
{
	m_rwLockStatus.ReaderLock();
	if (status != DEVICE_ACTIVE)
	{
...
int32_t StellaB1WheelController::SetVelocity(OPRoS::MobileVelocityData mobileVelocity)
{
	std::cout << "\StellaB1wheelController::setvelocity1\n" << std::endl;
	...
	std::cout << "\StellaB1wheelController::setvelocity2\n" << std::endl;

	double linearVelocity=0.0;
	double angularVelocity=0.0; 

	std::cout << "\StellaB1wheelController::setvelocity3\n" << std::endl;

	std::cout << "mobileVelocity : " << mobileVelocity.x << mobileVelocity.y << mobileVelocity.theta << "\n" << std::endl;
	linearVelocity = mobileVelocity.x;
	angularVelocity = mobileVelocity.theta;

	std::cout << "\StellaB1wheelController::setvelocity4\n" << std::endl;
	...
	std::cout << "linearVelocity : " << linearVelocity << "\n" << std::endl;

	std::cout << "\StellaB1wheelController::setvelocity5\n" << std::endl;

	double rightWheelSpeed = linearVelocity + m_profile.axleDistance * DEG2RAD(angularVelocity) / 2.0;
	double leftWheelSpeed = linearVelocity - m_profile.axleDistance * DEG2RAD(angularVelocity) / 2.0;

	std::cout << "rightWheelSpeed : " << rightWheelSpeed << "\n" << std::endl;
	std::cout << "leftWheelSpeed : " << leftWheelSpeed << "\n" << std::endl;

	std::cout << "\StellaB1wheelController::setvelocity6\n" << std::endl;
	...
	std::cout << "\StellaB1wheelController::setvelocity7\n" << std::endl;
	...
	std::cout << "\StellaB1wheelController::setvelocity8\n" << std::endl;
	...
	std::cout << "\StellaB1wheelController::setvelocity9\n" << std::endl;
	std::cout << std::endl;
	//////////////////////////////////////////////////////////////////////////
	m_rwLockStatus.ReaderUnlock();
	return API_SUCCESS;
}
bool StellaB1WheelController::SetStellaB1Profile(OPRoS::Property parameter )
{
	PrintMessage("--------------------------------\r\n");
	PrintMessage("StellaB1WheelController Profiles\r\n");
	PrintMessage("--------------------------------\r\n");
