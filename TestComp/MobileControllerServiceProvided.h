...
#include "OPRoS::MobileVelocityData.h"
...
class IMobileControllerService
{
 public:
    ...
    virtual ReturnType MoveBase(float64_t distance,float64_t velocity)=0;
    virtual ReturnType RotateBase(float64_t angle,float64_t velocity)=0;
 ...
 *
 */
class MobileControllerServiceProvided
	:public ProvidedServicePort, public IMobileControllerService
{
protected:
...
public: // default method
   ...
   virtual ReturnType MoveBase(float64_t distance,float64_t velocity)
   {
		opros_assert(MoveBaseFunc != NULL);
            ...
            return (*MoveBaseFunc)(distance,velocity);
   ...
   virtual ReturnType RotateBase(float64_t angle,float64_t velocity)
   {
		opros_assert(RotateBaseFunc != NULL);
            ...
            return (*RotateBaseFunc)(angle,velocity);
