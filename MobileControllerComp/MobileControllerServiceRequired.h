 ...
 *
 */
class MobileControllerServiceRequired
...
public:
	...
	ReturnType MoveBase(float64_t distance,float64_t velocity)
	{
	...
	ReturnType RotateBase(float64_t angle,float64_t velocity)
	{
