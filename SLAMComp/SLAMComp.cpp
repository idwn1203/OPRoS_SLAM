		...
		if (Predict(position) || !isInitialized) {
			if (ptrLaserScannerService) {
				auto sensorData = ptrLaserScannerService->GetSensorValue();
					std::cout << "Slam Laser DAta 2 : "<< sensorData.at(0).data[0] << std::endl;
					std::cout << "Slam Laser DAta 2 : "<< sensorData.at(0).data[1] << std::endl;
					std::cout << "Slam Laser DAta 2 : "<< sensorData.at(0).data[2] << std::endl;
					std::cout << "Slam Laser DAta 2 : "<< sensorData.at(0).data[340] << std::endl;
					//std::cout << "Slam Laser DAta 2 : "<< sensorData.at(0).data[342] << std::endl;
					//std::cout<<"data size :"<<sensorData.at(0).data.size<<std::endl;
					//std::cout << "Slam Laser DAta 2 : "<< sensorData.at(1).data[0] << std::endl;
					//std::cout << "Slam Laser DAta 2 : "<< sensorData.at(1).data[1] << std::endl;
					//std::cout << "Slam Laser DAta 2 : "<< sensorData.at(1).data[2] << std::endl;
					//std::cout << "Slam Laser DAta 2 : "<< sensorData.at(1).data[341] << std::endl;
					//std::cout << "Slam Laser DAta 2 : "<< sensorData.at(1).data[342] << std::endl;
					if (sensorData.empty())
					return false;

				auto& laserData = sensorData[0].data;

				//std::cout << "SLAMComp::Localize() = laser size = " << laserData.size() << std::endl;
					std::cout << "Slam Laser DAta 3 : "<< sensorData.at(0).data[0] << std::endl;
					std::cout << "Slam Laser DAta 3 : "<< sensorData.at(0).data[1] << std::endl;
					std::cout << "Slam Laser DAta 3 : "<< sensorData.at(0).data[2] << std::endl;
					std::cout << "Slam Laser DAta 3 : "<< sensorData.at(1).data[0] << std::endl;
					//std::cout << "Slam Laser DAta 3 : "<< sensorData.at(0).data[342] << std::endl;
